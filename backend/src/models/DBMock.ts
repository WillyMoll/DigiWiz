class DBMock {
    ...
    constructor() {
        ...
        this.solutions.push(new Solution(1, "https://ebanking-ch4.ubs.com/workbench/WorkbenchOpenAction.do?login&", "Wir bieten Ihnen für jedes Bedürfnis die passende Banklösung. Egal, ob es dabei um Konten und Karten, ein Eigenheim, Vorsorge oder eine Geldanlage geht.", ubs, []));
        this.solutions.push(new Solution(1, "https://www.bexio.com/en-CH/product-overview", "Print invoices directly or send them the convenient, electronic way. The orange payment slip makes bank reconciliation a breeze. That means you get paid faster. Incoming bills from suppliers you simply scan and post. Simple dashboards allow you to keep track of incoming and outgoing payments.", bexio, []));
        this.solutions.push(new Solution(1, "https://trello.com/en/pricing", "Trusted by millions, Trello powers teams all around the world. Explore which option is right for you.", trello, []));
        this.solutions.push(new Solution(1, "https://www.zoho.com/projects", "The best project management software for any business", zoho, []));
        this.solutions.push(new Solution(1, "https://slack.com/intl/de-ch", "Slack ist die Zukunft der Arbeit", slack, []));
